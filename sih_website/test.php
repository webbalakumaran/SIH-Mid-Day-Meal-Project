...
.navbar {
  ...
  <div class="container-fluid">
    ...
    echo "<tr><th style='border-right: solid 1px black;'>Id</th><th>Firstname</th></tr>";
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT day, menu FROM menu");
        $stmt->execute();
    ...
    <footer class="container-fluid" style="background-color:black;width:100%;color:white;">
      <center>
