...
.navbar {
  ...
  <div class="container-fluid">
    ...
    <br>
    <br>
    <h1>District wise representation</h1>
    <br>
    <br>
    <?php
    echo "<table style='border: solid 1px black;border-collapse: collapse;' class='table'>";
    echo "<tr><th style='border-right: solid 1px black;'>School_name</th><th style='border-right: solid 1px black;'>School_Id</th><th style='border-right: solid 1px black;'>Supplier_name</th><th style='border-right: solid 1px black;'>Supplier_Id</th><th style='border-right: solid 1px black;'>District</th></tr>";
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT school_name, School_Id,supplier_name,supplier_id,district  FROM supply_log");
        $stmt->execute();
