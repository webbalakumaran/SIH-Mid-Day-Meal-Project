...
.navbar {
  ...
  <div class="container-fluid">
    ...
    <br>
    <br>
    <h1>School Level representation</h1>
    <br><br>
    <?php
    echo "<table style='border: solid 1px black;border-collapse: collapse;' class='table'>";
    echo "<tr><th style='border-right: solid 1px black;'>School_name</th><th style='border-right: solid 1px black;'>School_Id</th><th style='border-right: solid 1px black;'>Primary Count</th><th style='border-right: solid 1px black;'>Secondary Count</th><th style='border-right: solid 1px black;'>Supplier_Id</th><th style='border-right: solid 1px black;'>Supplier_name</th></tr>";
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT school_name,school_id,pc,sc,supplier_id,supplier_name FROM supply_log");
        $stmt->execute();
